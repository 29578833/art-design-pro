...
<script setup lang="ts">
  ...
  import type { OrderAttachment, OrderDetail } from '@/types/recycle/recovery/orders/order'
  import { resolveVehicleAttachments } from '@/types/recycle/recovery/orders/order'
