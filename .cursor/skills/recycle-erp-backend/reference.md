...
- **原型代码目录**：`C:\Users\29758\Desktop\figma_yuanxing_front`（Figma Make 导出，React 可交互原型；下文简称 `回收拆车项目/`）
...
```bash
cd "C:/Users/29758/Desktop/figma_yuanxing_front"    # 原型代码目录（上文简称 `回收拆车项目/`）
pnpm i
pnpm dev
```
